...
void Application::start()
{
	...
	m_sprite_red_ship		= new Sprite("../media/Spaceship_Red.bmp");
	m_sprite_red_laser		= new Sprite("../media/Laser_Red.bmp");
	m_sprite_red_rocket		= new Sprite("../media/Rocket_Red.bmp");
	m_sprite_blue_ship		= new Sprite("../media/Spaceship_Blue.bmp");
	m_sprite_blue_laser		= new Sprite("../media/Laser_Blue.bmp");
	m_sprite_blue_rocket	= new Sprite("../media/Rocket_Blue.bmp");

	m_object_ship0.setSprite(m_sprite_red_ship);
	m_object_ship0.setPos(Vector(100.0f, 300.0f, 0.0f));
	m_object_ship0.setRotation(0.0f);
	m_object_ship0.setBlendMode(ADDITIVE);

	m_object_ship1.setSprite(m_sprite_blue_ship);
	m_object_ship1.setPos(Vector(700.0f, 300.0f, 0.0f));
...
void Application::CheckPlayerShipColour()
{
	...
	{
		m_object_ship0.setSprite(m_sprite_blue_ship);
		m_object_ship1.setSprite(m_sprite_red_ship);
	}
}
